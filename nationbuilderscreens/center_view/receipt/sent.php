		...
		<div class="span6">
			<div class="widget-box" style="background:#EEEEEE;border: none;">
				<select id="receipt_status">
					<option value="receipts-sent.php" selected>Receipts Sent</option>
					<option value="receipts-not-sent.php">Receipts Not Sent</option>
				</select>
			</div>
		</div>
	</div>
			...
			<table class="table table-bordered receipts_sent">
				...
				<tbody>
					<tr>
						...
						<td>Template 1</td>
						<td>
							<a href="receipts-sent-edit.php" title="Edit">
